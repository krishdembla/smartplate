...
This model predicts \emph{which} food groups are present but not \emph{how much} of each, so it cannot produce a health score --- establishing the necessity of pixel-level proportions for this task.
